...
__decorate([
    n()
], LitEl.prototype, "name", void 0);
customElements.define('lit-el', LitEl);

class LitEl2 extends s {
    render() {
        return x `<bench-el></bench-el>`;
    }
}
__decorate([
    n()
], LitEl2.prototype, "name", void 0);
customElements.define('lit-el2', LitEl2);

class LitEl3 extends s {
    render() {
        return x `${this.name}`;
    }
}
__decorate([
    n()
], LitEl3.prototype, "name", void 0);
customElements.define('lit-el3', LitEl3);

class MyEl extends s {
    ...
    render() {
        return x `<lit-el .name=${this.name1}></lit-el
